        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              <img class="w-auto h-32" src="Plogo.png" alt="" />
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
              ...
              <form action="#" method="POST" class="mt-6">
                ...
                <button
                  type="submit"
                  class="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-black rounded-md hover:bg-gray-900 focus:bg-blue-700"
                >
                  Subscribe
                </button>
              </form>
          ...
          <p class="text-sm text-center text-gray-600">
            © Copyright 2021, All Rights Reserved by Porsche
          </p>
        </div>
       <div className="flex justify-between items-center w-full p-4">
  {/* Center logo */}
  <div className="absolute left-1/2 transform -translate-x-1/2">
    <img src="PLOGO.png" alt="Center Logo" className="w-56 h-auto" />
  </div>
  </div>
      </section>
    </div>
